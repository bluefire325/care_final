...
class _AgendaPageState extends State<AgendaPage> {
  ...
  Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(title: Text("Agenda Today"),),
      body: isLoadComplete  == true ? ListView.builder(
        itemCount: selAgenda.length,
        itemBuilder: (BuildContext context,int index){
          return ListTile(title: Text(selAgenda[index].question.toString(),style: TextStyle(color: Colors.black)),onTap: (){
            showSimpleCustomDialog(context,selAgenda[index].question);
          },);
        },
 ...
 void getUsertype() async {
  ...
  void showSimpleCustomDialog(BuildContext context,String question) {
