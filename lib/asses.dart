   ...
   Widget build(BuildContext context) {
      ...
      body: isLoadComplete  == true ? ListView.builder(
        ...
        itemBuilder: (BuildContext context,int index){
          return ListTile(title: Text(selQuestion[index].question.toString(),style: TextStyle(color: Colors.black)),onTap: (){
            showSimpleCustomDialog(context,selQuestion[index].question);
          },);
        },
